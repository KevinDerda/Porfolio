        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-3" id=polaris>
                    <img src="public/img/parcours2.png" class="img-fluid animate__animated animate__rotateInUpRight"
                         alt="Polaris">
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-12 d-md-none">
                    <img src="public/img/parcours1.png" class="wow img-fluid animate__animated animate__rotateInUpRight"
                         alt="Polaris">
                </div>
            </div>
        </div>
